...
export const PERMIT_CATEGORIES: Record<string, PermitPermission[]> = {
    'Moderation': [
        ...
        PermitPermission.CHANGE_NICKNAME,
    ],
    'Channel Management': [
        PermitPermission.VIEW_CHANNEL,
        PermitPermission.MANAGE_CHANNELS,
        PermitPermission.MANAGE_THREADS,
        PermitPermission.CREATE_PUBLIC_THREADS,
        PermitPermission.CREATE_PRIVATE_THREADS,
    ],
    'Role Management': [
    ...
    'Server Management': [
        ...
        PermitPermission.VIEW_CREATOR_MONETIZATION_ANALYTICS,
    ],
    'Voice': [
        ...
        PermitPermission.USE_SOUNDBOARD,
        PermitPermission.USE_EXTERNAL_SOUNDS,
        PermitPermission.REQUEST_TO_SPEAK,
    ],
    'Communication': [
        PermitPermission.SEND_MESSAGES,
        PermitPermission.SEND_MESSAGES_IN_THREADS,
        PermitPermission.SEND_TTS_MESSAGES,
        PermitPermission.SEND_VOICE_MESSAGES,
        PermitPermission.READ_MESSAGE_HISTORY,
        ...
        PermitPermission.USE_APPLICATION_COMMANDS,
        PermitPermission.USE_EMBEDDED_ACTIVITIES,
...
export const PERMIT_TO_DISCORD_PERM: Partial<Record<PermitPermission, bigint>> = {
    ...
    [PermitPermission.CHANGE_NICKNAME]: PermissionFlagsBits.ChangeNickname,
    [PermitPermission.VIEW_CHANNEL]: PermissionFlagsBits.ViewChannel,
    ...
    [PermitPermission.CREATE_PUBLIC_THREADS]: PermissionFlagsBits.CreatePublicThreads,
    [PermitPermission.CREATE_PRIVATE_THREADS]: PermissionFlagsBits.CreatePrivateThreads,
    ...
    [PermitPermission.VIEW_CREATOR_MONETIZATION_ANALYTICS]: PermissionFlagsBits.ViewCreatorMonetizationAnalytics,
    ...
    [PermitPermission.USE_SOUNDBOARD]: PermissionFlagsBits.UseSoundboard,
    [PermitPermission.USE_EXTERNAL_SOUNDS]: PermissionFlagsBits.UseExternalSounds,
    [PermitPermission.REQUEST_TO_SPEAK]: PermissionFlagsBits.RequestToSpeak,
    [PermitPermission.SEND_MESSAGES]: PermissionFlagsBits.SendMessages,
    [PermitPermission.SEND_MESSAGES_IN_THREADS]: PermissionFlagsBits.SendMessagesInThreads,
    [PermitPermission.SEND_TTS_MESSAGES]: PermissionFlagsBits.SendTTSMessages,
    [PermitPermission.SEND_VOICE_MESSAGES]: PermissionFlagsBits.SendVoiceMessages,
    [PermitPermission.READ_MESSAGE_HISTORY]: PermissionFlagsBits.ReadMessageHistory,
    ...
    [PermitPermission.USE_APPLICATION_COMMANDS]: PermissionFlagsBits.UseApplicationCommands,
    [PermitPermission.USE_EMBEDDED_ACTIVITIES]: PermissionFlagsBits.UseEmbeddedActivities,
